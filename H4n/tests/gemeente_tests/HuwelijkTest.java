...
import oefeningen.oefening4.Huwelijk;
...
public class HuwelijkTest {
    ...
    private static final Persoon PARTNER1 = new Persoon("Vervoort", "Jos",  new Adres("Nieuwstraat", "156B", 3500, "Hasselt"));
    private static final Persoon PARTNER2 = new Persoon("Bex", "Jeanne",  new Adres("Vlierstraat", "14", 3600, "Genk"));
    ...
    @Before
    public void init() {
        huwelijk = new Huwelijk(PARTNER1, PARTNER2);
    }
